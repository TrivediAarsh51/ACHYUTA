...
class Request:
    """
    Represents a security-relevant operation.

    This follows ACHYUTA's request-centric model.
    """
...
def evaluate_policy(
    ...
    Returns a PolicyResult rather than making a final authorization decision.
    """
    ...
    if not policy_id:
        raise ValueError("Policy is missing required field: id")
    ...
    matched, reasons = _check_conditions(
        conditions,
        request,
    )
